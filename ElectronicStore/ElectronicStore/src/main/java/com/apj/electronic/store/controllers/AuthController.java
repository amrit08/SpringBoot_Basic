...
import com.apj.electronic.store.dtos.JwtRequest;
import com.apj.electronic.store.dtos.JwtResponse;
...
import com.apj.electronic.store.security.JwtHelper;
...
public class AuthController
{
    ...
    public ResponseEntity<JwtResponse> loginWithGoogle(@RequestBody Map<String ,Object> data) throws IOException {
        ...
        ResponseEntity<JwtResponse> jwtResponseResponseEntity = this.login(JwtRequest.builder().name(user.getName()).password(newPassword).build());
